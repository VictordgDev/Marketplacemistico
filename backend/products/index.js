...
async function postHandler(req, res) {
  ...
  if (!nome || !categoria || preco === null) {
    return sendError(res, 'VALIDATION_ERROR', 'Campos obrigatorios faltando (nome, categoria, preco)');
  }

  if (!dimensionsValidation.ok) {
    return sendError(res, 'VALIDATION_ERROR', dimensionsValidation.reason);
  }
